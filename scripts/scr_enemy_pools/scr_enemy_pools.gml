...
global.enemy_difficulty_map = {
    ...
    evil_tree: ENEMY_DIFFICULTY.MEDIUM,
    ...
    switch(level_difficulty) {
        ...
        case 2:
            return {
                ...
                allowed_enemies: [obj_zombie, obj_boar, obj_evil_tree],
        ...
        case 3:
            return {
                ...
                allowed_enemies: [obj_boar, obj_evil_tree, obj_ghost],
...
function get_enemy_difficulty(enemy_object) {
    ...
    if (enemy_object == obj_evil_tree) return ENEMY_DIFFICULTY.MEDIUM;
